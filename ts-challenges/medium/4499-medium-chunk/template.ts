 ...
 * 从零开始
 */
type Splice<T extends unknown[], N extends number> = T extends [...BuildArr<N>, ...infer Rest] ? Rest : []
/**
 * 返回被截取的部分
 * 从零开始
 */
type Slice<T extends unknown[], N extends number> = T extends [...infer Rest, ...BuildArr<Subtract<T['length'], N>>] ? Rest : []
